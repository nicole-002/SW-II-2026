<?php
    ...
    foreach ( $empregados as $e ){ //é nescessário um laço de repetição para exibir toda a lista, o foreach já mostra todos os itensde uma vez sem precisar definir a qnt (while e for)
